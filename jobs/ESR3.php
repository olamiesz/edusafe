<div class="span9">
	...
	<p>You will design a system architecture, for the wearable system,
		...
		transmission, in an optimised way. Work will be directed towards
		resolving problems with multiple radio waves arriving in the same
		antenna from different paths. Finally, a systematic methodology will
		be developed to determine the best configuration of component parts to
	...
	<h3>Contact</h3>
	<p>
		<a href="mailto:hr@novocaptis.com">NOVOCAPTIS</a>, including
		TR-EDUSAFE-ESR-2012 as the subject of your mail
	</p>
